    ...
    stages {
        ...
        stage('Deploy to S3') {
            steps {
                ...
                script {
                    sh "aws s3 cp public/index.html s3://jenkinstf-ec2-static-bucket1111/"
                    sh "aws s3 cp public/error.html s3://jenkinstf-ec2-static-bucket1111/"
                }
            }
        }
        ...
        stage('Set Bucket Policy') {
            steps {
                ...
                script {
                    sh "aws s3api put-bucket-policy --bucket jenkinstf-ec2-static-bucket1111 --policy file://policy.json"
                }
            }
        }
    }
